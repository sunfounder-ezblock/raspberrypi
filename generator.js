...
Blockly.Python['raspberrypi_analog_pin'] = function(block) {  // digital pin number
    var pin = block.getFieldValue('pin');
...
Blockly.Python['raspberrypi_device_pin'] = function(
...
Blockly.Python['raspberrypi_pwm_pin'] = function(block) {  // digital pin number
    var pin = block.getFieldValue('pin');

    Blockly.Python.definitions_['import_raspberrypi_pwm'] =
...
Blockly.Python['raspberrypi_pin_irq'] = function(block) {
    ...
    var trigger = Blockly.Python.valueToCode(
            block, 'irq_trigger', Blockly.Python.ORDER_ATOMIC);
    var statements_irq_handler =
            Blockly.Python.statementToCode(block, 'irq_handler');
...
Blockly.Python['raspberrypi_servo_set_angle'] = function(block) {
    var value_pin = Blockly.Python.valueToCode(
            block, 'servo_pin', Blockly.Python.ORDER_ATOMIC);
    var value_angle =
...
Blockly.Python['raspberrypi_connect_wifi'] = function(block) {
    var country =
            Blockly.Python.valueToCode(block, 'country', Blockly.Python.ORDER_ATOMIC);
    var ssid =
            Blockly.Python.valueToCode(block, 'ssid', Blockly.Python.ORDER_ATOMIC);
    var password = Blockly.Python.valueToCode(
            block, 'password', Blockly.Python.ORDER_ATOMIC);
    Blockly.Python.definitions_['import_raspberrypi_wifi'] =
            'from raspberrypi import WiFi';
...
Blockly.Python['raspberrypi_write_i2c'] = function(block) {
    var address =
            Blockly.Python.valueToCode(block, 'address', Blockly.Python.ORDER_ATOMIC);
    var Register_address = Blockly.Python.valueToCode(
            block, 'Register_address', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python['raspberrypi_spi'] = function(block) {
    var bus =
            Blockly.Python.valueToCode(block, 'bus', Blockly.Python.ORDER_ATOMIC);
    var device =
            Blockly.Python.valueToCode(block, 'device', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python['raspberrypi_i2c_send'] = function(block) {
    var send =
            Blockly.Python.valueToCode(block, 'send', Blockly.Python.ORDER_ATOMIC);
    var addr =
            Blockly.Python.valueToCode(block, 'addr', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python['raspberrypi_i2c_recv'] = function(block) {
    var recv =
            Blockly.Python.valueToCode(block, 'recv', Blockly.Python.ORDER_ATOMIC);
    var addr =
            Blockly.Python.valueToCode(block, 'addr', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python['raspberrypi_i2c_mem_write'] = function(block) {
    ...
    var addr =
            Blockly.Python.valueToCode(block, 'addr', Blockly.Python.ORDER_ATOMIC);
    var memaddr =
            Blockly.Python.valueToCode(block, 'memaddr', Blockly.Python.ORDER_ATOMIC);
